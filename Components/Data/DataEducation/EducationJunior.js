...
export default class EducationJunior extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      result: false,
  ...
  educationjunior = () => {
    ...
    postData(educationjunior, { name: 'EducationJunior' })
      .then(async (data) => {
        this.setState({ edujun: data });
      })
  }
      ...
      <View style={{ flex: 1, backgroundColor: "#ffffff" }}>
        ...
        <ScrollView>
          <View style={{ flex: 1, alignItems: "center", justifyContent: 'center', margin: 25, }}>
            {
              this.state.edujun.map((item, key) => (
                <View key={key}>
