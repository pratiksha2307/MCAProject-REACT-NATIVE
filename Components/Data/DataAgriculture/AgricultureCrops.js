...
export default class AgricultureCrops extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      result: false,
 ...
 agriculturecrops = () => {
    ...
    postData(agriculturecrops, { name: 'AgricultureCrops' })
      .then(async (data) => {
        this.setState({ agrcro: data });
      })
  }
      ...
      <View style={{ flex: 1, backgroundColor: "#ffffff" }}>
        ...
        <ScrollView>
          <View style={{ flex: 1, alignItems: "center", justifyContent: 'center', margin: 25, }}>
            {
              this.state.agrcro.map((item, key) => (
                <View key={key}>
