...
export default class AgricultureDigital extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      result: false,
 ...
 agriculturedigital = () => {
    ...
    postData(agriculturedigital, { name: 'AgricultureDigital' })
      .then(async (data) => {
        this.setState({ agrdig: data });
      })
  }
      ...
      <View style={{ flex: 1, backgroundColor: "#ffffff" }}>
        ...
        <ScrollView>
          <View style={{ flex: 1, alignItems: "center", justifyContent: 'center', margin: 25, }}>
            {
              this.state.agrdig.map((item, key) => (
                <View key={key}>
