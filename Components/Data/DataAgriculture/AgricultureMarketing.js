...
export default class AgricultureMarketing extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      result: false,
 ...
 agriculturemarketing = () => {
    ...
    postData(agriculturemarketing, { name: 'AgricultureMarketing' })
      .then(async (data) => {
        this.setState({ agrmar: data });
      })
  }
      ...
      <View style={{ flex: 1, backgroundColor: "#ffffff" }}>
        ...
        <ScrollView>
          <View style={{ flex: 1, alignItems: "center", justifyContent: 'center', margin: 25, }}>
            {
              this.state.agrmar.map((item, key) => (
                <View key={key}>
