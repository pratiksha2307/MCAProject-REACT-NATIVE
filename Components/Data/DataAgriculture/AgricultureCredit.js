...
export default class AgricultureCredit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      result: false,
 ...
 agriculturecredit = () => {
    ...
    postData(agriculturecredit, { name: 'AgricultureCredit' })
      .then(async (data) => {
        this.setState({ agrcre: data });
      })
  }
      ...
      <View style={{ flex: 1, backgroundColor: "#ffffff" }}>
        ...
        <ScrollView>
          <View style={{ flex: 1, alignItems: "center", justifyContent: 'center', margin: 25, }}>
            {
              this.state.agrcre.map((item, key) => (
                <View key={key}>
