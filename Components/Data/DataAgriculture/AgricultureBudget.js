...
export default class AgricultureBudget extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      result: false,
 ...
 agriculturebudget = () => {
    ...
    postData(agriculturebudget, { name: 'AgricultureBudget' })
      .then(async (data) => {
        this.setState({ agrbud: data });
      })
  }
      ...
      <View style={{ flex: 1, backgroundColor: "#ffffff" }}>
        ...
        <ScrollView>
          <View style={{ flex: 1, alignItems: "center", justifyContent: 'center', margin: 25, }}>
            {
              this.state.agrbud.map((item, key) => (
                <View key={key}>
