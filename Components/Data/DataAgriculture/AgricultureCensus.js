...
export default class AgricultureCensus extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      result: false,
 ...
 agriculturecensus = () => {
    ...
    postData(agriculturecensus, { name: 'AgricultureCensus' })
      .then(async (data) => {
        this.setState({ agrcen: data });
      })
  }
      ...
      <View style={{ flex: 1, backgroundColor: "#ffffff" }}>
        ...
        <ScrollView>
          <View style={{ flex: 1, alignItems: "center", justifyContent: 'center', margin: 25, }}>
            {
              this.state.agrcen.map((item, key) => (
                <View key={key}>
